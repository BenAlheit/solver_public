...
#ifndef SOLVER_SOLVEREXAMPLE_H
#define SOLVER_SOLVEREXAMPLE_H
...
#include "materials/SingleInclude.h"
...
namespace SolverExample {
    ...
    ElasticProblem<dim>::ElasticProblem()
            : mpi_communicator(MPI_COMM_WORLD), n_mpi_processes(Utilities::MPI::n_mpi_processes(mpi_communicator)),
              ...
              pcout(std::cout, (this_mpi_process == 0)), fe(FE_Q<dim>(1), dim), dof_handler(triangulation) {}
        ...
        if (this_mpi_process == 0) {
            ...
            switch (dim) {
                ...
                case 3:
                    ...
                    break;
                default: Assert(false, ExcInternalError());
            }
