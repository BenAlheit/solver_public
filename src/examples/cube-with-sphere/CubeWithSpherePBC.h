...
class CubeWithSpherePBC {
public:
    explicit CubeWithSpherePBC(unsigned int n_refinements = 2);
...
template<unsigned int dim>
CubeWithSpherePBC<dim>::CubeWithSpherePBC(unsigned int n_refinements):
        n_refinements(n_refinements) {

    iota(range.begin(), range.end(), 0);
    read_and_refine_mesh();
//    string name = "elastic-cube-with-particle";
//    string name = "elastic-cube-with-particle-pbc-psc-const-vol";
    string name = "elastic-cube-particle-shear";
...
#endif //SOLVER_CUBEWITHSPHEREPBC_H
