...
#ifndef SOLVER_ELASTOPLASTICCUBE_H
#define SOLVER_ELASTOPLASTICCUBE_H
...
#include "../materials/RateDependentPlasticity.h"
#include "../materials/RateIndependtPlasticity.h"
...
class ElastoPlasticCube {
public:
    explicit ElastoPlasticCube(unsigned int n_refinements = 1);
...
template<unsigned int dim>
ElastoPlasticCube<dim>::ElastoPlasticCube(unsigned int n_refinements) : n_refinements(n_refinements) {
    iota(range.begin(), range.end(), 0);

    make_mesh();
    string name = "elastoplastic-cube";
//    E = 206.9 GPa, ν= 0.29,
//    σ0 = 0.45 GPa, σ∞ = 0.715 GPa, δ= 16.93, H= 0.12924 GPa.
...
//    auto hardening_law = new VoceWLinear<dim>(0.45e3, 0.715e3, 500, 0.12924e3);
...
template<unsigned int dim>
void ElastoPlasticCube<dim>::make_mesh() {
...
#endif //SOLVER_ELASTOPLASTICCUBE_H
